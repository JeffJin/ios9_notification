...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didReceiveLocalNotification notification: UILocalNotification) {
        NSLog("didReceiveLocalNotification...postNotificationName::TodoListShouldRefresh")
    ...
    func applicationDidBecomeActive(application: UIApplication) {
        ...
        NSLog("applicationDidBecomeActive...postNotificationName::TodoListShouldRefresh")
        NSNotificationCenter.defaultCenter().postNotificationName("TodoListShouldRefresh", object: self)
    }
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "io.eworks.twilio" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("twilio", withExtension: "momd")!
